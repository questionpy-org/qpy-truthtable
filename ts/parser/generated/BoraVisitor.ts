...
import { ImplicitVariableAndOperatorContext } from "./BoraParser.js";
import { ImplicitTermAndOperatorContext } from "./BoraParser.js";
...
export default class BoraVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `implicitVariableAndOperator`
	 * labeled alternative in `BoraParser.term`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitImplicitVariableAndOperator?: (ctx: ImplicitVariableAndOperatorContext) => Result;
	/**
	 * Visit a parse tree produced by the `implicitTermAndOperator`
	 * labeled alternative in `BoraParser.term`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitImplicitTermAndOperator?: (ctx: ImplicitTermAndOperatorContext) => Result;
	/**
